...
### Installing guide
 ...
 1. App can be installed by YunoHost **admin web-interface** or by **running following command**:
         ...
         $ sudo yunohost app install https://github.com/ScchutzZ/teamspeak-3_ynh
 
 1. Run Server in SSH.
 
	 $ sh /home/yunohost.app/ts3server/server/ts3server_startscript.sh start

 
### Upgrade this package:

        $ sudo yunohost app upgrade --verbose example -u https://github.com/ScchutzZ/teamspeak-3_ynh
